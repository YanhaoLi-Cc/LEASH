#!/usr/bin/env bash
# LEASH: DeepSeek-R1-Distill-Qwen-1.5B, target length 4k
...
project_name='LEASH'
exp_name='leash-r1-1.5b-target4k'
...
# ============================================================
MODEL_PATH=${MODEL_PATH:?"Please set MODEL_PATH to your DeepSeek-R1-Distill-Qwen-1.5B checkpoint"}
...
# ============================================================
# LEASH settings (paper best: 1.5B Lt=4k)
# ============================================================
use_leash=True
target_length=4096
lambda_init=0.1
